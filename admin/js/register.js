(()=>{
    $('#crear-register').on('submit',saveRegister);
    $('.editRegister').click(getRegisterEditInfo);
    $('.deleteRegister').click(modalDelete);
    $('#delete_category_admin').on('submit',deleteRegister);
    $('#edit_category_info').on('submit',editRegister);
    ...
    function getRegisterEditInfo(event){
        event.preventDefault();
