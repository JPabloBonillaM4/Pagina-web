  ...
  <section class="seccion contenedor">
      ...
      <form action="validar_registro.php" id="registro" class="registro" method="POST">
          <div id="datos_usuario" class="registro caja clearfix">
                ...
                <div id="error"></div><!--Div para mensaje de error-->
          </div>
                    ...
                    <li>
                      <div class="tabla-precio">
                        ...
                        <div class="orden">
                            ...
                            <input type="number" name="boletos[]" id="pase_dia" size="3" placeholder="0" min="0">
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div class="tabla-precio">
                        ...
                        <div class="orden">
                            ...
                            <input type="number" name="boletos[]" id="pase_completo" size="3" placeholder="0" min="0">
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div class="tabla-precio">
                        ...
                        <div class="orden">
                            ...
                            <input type="number" name="boletos[]" id="pase_2_dias" size="3" placeholder="0" min="0">
                        </div>
                      </div>
                    </li>
            ...
            <div id="resumen" class="resumen clearfix">
                ...
                <div class="caja clearfix">
                    ...
                    <div class="total">
                        ...
                        <input type="submit" id="btn_registro" name="submit" class="boton" value="Pagar">
                    </div><!--Total-->
                </div><!--CAJA-->
            </div><!--RESUMEN-->
      </form>
